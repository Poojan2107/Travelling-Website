...
const services = [
  ...
  { icon: 'fa-bed', title: 'Sleeping Bags', desc: 'Thermal insulated sleeping bags ensuring a cozy night\'s sleep under the stars.' },
  { icon: 'fa-fire', title: 'Camp Stoves', desc: 'Portable, high-efficiency stoves for cooking delicious meals anywhere.' },
  { icon: 'fa-suitcase-rolling', title: 'Backpacks', desc: 'Ergonomic, high-capacity backpacks to carry all your essential life resources.' },
